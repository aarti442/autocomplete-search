...
class Atcl_Autocomplete_Search
{
    ...
    private function load_dependencies()
    {
         ...
         * core plugin.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-autocomplete-search-loader.php';

        /**
         * The class responsible for defining internationalization functionality
         * of the plugin.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-autocomplete-search-i18n.php';

        /**
         * The class responsible for defining all actions that occur in the admin area.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-autocomplete-search-admin.php';

        /**
         * The class responsible for defining all actions that occur in the public-facing
         * side of the site.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'public/class-autocomplete-search-public.php';

        /**
         * The class responsible for defining all shortcodes that occur in the public-facing
         * side of the site.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/shortcodes.php';
        
        /**
         * The class responsible for defining all actions that occur in the public-facing
         * side of the site.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'includes/actions.php';
        
        /**
         * The class responsible for defining all settings that occur in the public-facing
         * side of the site.
         */
        include_once plugin_dir_path(dirname(__FILE__)) . 'admin/includes/settings.php';
