...
function atcl_activate_autocomplete_search() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-autocomplete-search-activator.php';
...
function atcl_deactivate_autocomplete_search() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-autocomplete-search-deactivator.php';
